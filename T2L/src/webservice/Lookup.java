...
public class Lookup implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":lookup", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "lookup", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Lookup parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"lookup".equals(type)) {
                            ...
                            return (Lookup) webservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
